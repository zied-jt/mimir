...
func ValidateAPIReceiver(ctx context.Context, api *APIReceiver, decrypt GetDecryptedValueFn) (GrafanaReceiverTyped, error) {
	...
	parseConfig := func(receiver *GrafanaReceiver) error {
		...
		case "prometheus-alertmanager":
			return createReceiver[alertmanager.Config](receiver)(alertmanager.ValidateConfig(receiver.Settings, decryptFn))(func(f *NotifierConfig[alertmanager.Config]) {
				result.AlertmanagerConfigs = append(result.AlertmanagerConfigs, f)
			})
		case "dingding":
			return createReceiver[dinding.Config](receiver)(dinding.ValidateConfig(receiver.Settings))(func(f *NotifierConfig[dinding.Config]) {
				result.DingdingConfigs = append(result.DingdingConfigs, f)
			})
		case "discord":
			return createReceiver[discord.Config](receiver)(discord.ValidateConfig(receiver.Settings))(func(f *NotifierConfig[discord.Config]) {
				result.DiscordConfigs = append(result.DiscordConfigs, f)
			})
		case "email":
			return createReceiver[email.Config](receiver)(email.ValidateConfig(receiver.Settings))(func(f *NotifierConfig[email.Config]) {
				result.EmailConfigs = append(result.EmailConfigs, f)
			})
		case "googlechat":
			return createReceiver[googlechat.Config](receiver)(googlechat.ValidateConfig(receiver.Settings))(func(f *NotifierConfig[googlechat.Config]) {
				result.GooglechatConfigs = append(result.GooglechatConfigs, f)
			})
		case "kafka":
			return createReceiver[kafka.Config](receiver)(kafka.ValidateConfig(receiver.Settings, decryptFn))(func(f *NotifierConfig[kafka.Config]) {
				result.KafkaConfigs = append(result.KafkaConfigs, f)
			})
		case "line":
			return createReceiver[line.Config](receiver)(line.ValidateConfig(receiver.Settings, decryptFn))(func(f *NotifierConfig[line.Config]) {
				result.LineConfigs = append(result.LineConfigs, f)
			})
		case "opsgenie":
			return createReceiver[opsgenie.Config](receiver)(opsgenie.ValidateConfig(receiver.Settings, decryptFn))(func(f *NotifierConfig[opsgenie.Config]) {
				result.OpsgenieConfigs = append(result.OpsgenieConfigs, f)
			})
		case "pagerduty":
			return createReceiver[pagerduty.Config](receiver)(pagerduty.ValidateConfig(receiver.Settings, decryptFn))(func(f *NotifierConfig[pagerduty.Config]) {
				result.PagerdutyConfigs = append(result.PagerdutyConfigs, f)
			})
		case "pushover":
			return createReceiver[pushover.Config](receiver)(pushover.ValidateConfig(receiver.Settings, decryptFn))(func(f *NotifierConfig[pushover.Config]) {
				result.PushoverConfigs = append(result.PushoverConfigs, f)
			})
		case "sensugo":
			return createReceiver[sensugo.Config](receiver)(sensugo.ValidateConfig(receiver.Settings, decryptFn))(func(f *NotifierConfig[sensugo.Config]) {
				result.SensugoConfigs = append(result.SensugoConfigs, f)
			})
		case "slack":
			return createReceiver[slack.Config](receiver)(slack.ValidateConfig(receiver.Settings, decryptFn))(func(f *NotifierConfig[slack.Config]) {
				result.SlackConfigs = append(result.SlackConfigs, f)
			})
		case "teams":
			return createReceiver[teams.Config](receiver)(teams.ValidateConfig(receiver.Settings))(func(f *NotifierConfig[teams.Config]) {
				result.TeamsConfigs = append(result.TeamsConfigs, f)
			})
		case "telegram":
			return createReceiver[telegram.Config](receiver)(telegram.ValidateConfig(receiver.Settings, decryptFn))(func(f *NotifierConfig[telegram.Config]) {
				result.TelegramConfigs = append(result.TelegramConfigs, f)
			})
		case "threema":
			return createReceiver[threema.Config](receiver)(threema.ValidateConfig(receiver.Settings, decryptFn))(func(f *NotifierConfig[threema.Config]) {
				result.ThreemaConfigs = append(result.ThreemaConfigs, f)
			})
		case "victorops":
			return createReceiver[victorops.Config](receiver)(victorops.ValidateConfig(receiver.Settings))(func(f *NotifierConfig[victorops.Config]) {
				result.VictoropsConfigs = append(result.VictoropsConfigs, f)
			})
		case "webhook":
			return createReceiver[webhook.Config](receiver)(webhook.ValidateConfig(receiver.Settings, decryptFn))(func(f *NotifierConfig[webhook.Config]) {
				result.WebhookConfigs = append(result.WebhookConfigs, f)
			})
		case "wecom":
			return createReceiver[wecom.Config](receiver)(wecom.ValidateConfig(receiver.Settings, decryptFn))(func(f *NotifierConfig[wecom.Config]) {
				result.WecomConfigs = append(result.WecomConfigs, f)
			})
		case "webex":
			return createReceiver[webex.Config](receiver)(webex.ValidateConfig(receiver.Settings, decryptFn))(func(f *NotifierConfig[webex.Config]) {
