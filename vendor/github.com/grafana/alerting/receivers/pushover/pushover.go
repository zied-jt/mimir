...
func New(cfg Config, info receivers.NotifierInfo, template *template.Template, sender receivers.WebhookSender, images images.ImageStore, logger logging.Logger) *Notifier {
	return &Notifier{
